...
function shouldBypassForLocalDevelopment() {
  ...
  // Friend-facing deployments must open from a normal link in mobile and
  // in-app browsers without relying on query parameters or local storage.
  const publicHostnames = new Set([
    "xrenyan.github.io",
    "rulequant-terminal.vercel.app",
  ]);
  if (publicHostnames.has(window.location.hostname)) return true;
