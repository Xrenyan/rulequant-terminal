...
export const troubleshootingTopics: GuideTopic[] = [{
  ...
  sections: [
    ...
    { kind: "troubleshooting", anchor: "invalid", title: "号码或导入异常", paragraphs: ["每期7个号码必须是1-49整数且互不重复；CSV列应为issue,n1,n2,n3,n4,n5,n6,special。"] },
    { kind: "troubleshooting", anchor: "formula", title: "公式计算异常", paragraphs: ["打开逐期明细核对变量、L/D序、特码、归一化和属性表；不确定就停用并标记，不要猜。"] },
    { kind: "troubleshooting", anchor: "worker", title: "计算一直整理中", paragraphs: ["系统会在后台线程失败时自动回退到主线程计算。若仍无结果，刷新后查看明确错误，并减少高级筛选深度。"] },
